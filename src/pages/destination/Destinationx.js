...
export default function DestinationxX() {
  ...
  return (
    <div className="destinationx-details">
      <div
        className="destinationx-details-hero"
        style={{ backgroundImage: `url(${state.banner})` }}
      >
        <div className="destinationx-details-content">
          <h2>{state.name}</h2>
      ...
      <main className="container">
        <div className="destinationx-action-btns">
